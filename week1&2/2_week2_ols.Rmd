...
Let us first go through Chapter 2 of Wooldridge together, especially:
...
When shareA increase by 1 standard deviation, we expect to observe voteA
to be higher by 0.9256 standard deviation. (if you are unsure if
conditional independence holds)
...
Stare at the $Var(\hat{\beta}_1)$ formula. **What does it reveal about
