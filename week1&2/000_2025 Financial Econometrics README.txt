...
课程会通过教材的例子和R（Rmarkdown）的上手进行

The course will use Rmarkdown, where you can practice interactively with the class examples.

Remark: If you are familiar with another Statistical programming language (Stata or Python), you are allowed to do the class examples and the homework using that programming language. But, you need to show your work using a notebook format (e.g. Jupyter notebook for Python and PyStata for Stata). Also, we only provide Q&A for R (Rmarkdown), not other programming languages. 
